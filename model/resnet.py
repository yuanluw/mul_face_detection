...
__author__ = 'https://github.com/ronghuaiyang/arcface-pytorch/model/resnet'
...
if __name__ == "__main__":
    ...
    net = net.cuda()
    net.load_state_dict(torch.load('/home/wyl/codeFile/mul_face_detection/pre_train/resnet18_110.pth'))
    net.eval()
    y = net(x)
    print(y.shape)